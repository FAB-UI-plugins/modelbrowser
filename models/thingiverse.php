<?php
class Thingiverse extends CI_Model {


	protected $_table_name = 'modelbrowser';
	...
	function __construct()
	{
		...
		parent::__construct();
		// Required
		$this->client_id = '96a71e1678901785f267';
		$this->client_secret = '6678b046abdfd41fc242e9c2172fedf1';
		
		// Optional, can also be set in Thingiverse app settings
		$this->redirect_uri = '';
		if (array_key_exists('thingiverse', $_SESSION)) {
			$this->access_token = $_SESSION['thingiverse']['access_token'];
		}
	...
	public function makeLoginURL()
	{
		...
		if ( ! empty($this->redirect_uri))
			$url .= '&redirect_uri=' . 'http://tohara.eu.pn/fabredirect.php';
		$url .= '&app_uri=' . $this->redirect_uri;
		return $url;
	}
	...
	public function oAuth($code)
	{
		...
		$_SESSION['thingiverse']['access_token'] = $this->access_token;
	}
